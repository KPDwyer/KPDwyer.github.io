...
window.addEventListener("load", () => {
  let mapi = new MastodonApi({
    ...
    instance_url: "https://mastodon.gamedev.place",
    ...
    link_see_more: "connect with me on Mastodon",
  });
});
  ...
  fetch(requestURL, {
    ...
    .then((jsonData) => {
      ...
      if (this.mtBodyContainer.innerHTML === "") {
        ...
        this.mtBodyContainer.innerHTML =
          '<div class="mt-error"><span class="mt-error-icon">📭</span><br/><strong>Sorry, no posts to show!</strong><br/><div class="mt-error-message"> ' +
          'Mastodon might have some issues, or I haven\'t made a post in a while!</div></div>';
      } else {
